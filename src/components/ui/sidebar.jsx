  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-transparent  flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}>
        {children}
...
function SidebarFooter({
  ...
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(`flex flex-col gap-2 py-4 px-2 
        bg-transparent
        `, className)}
      {...props} />
  );
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        `flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden group-data-[collapsible=icon]:overflow-y-auto group-data-[collapsible=icon]:overflow-x-hidden p-2
        bg-transparent`,
        className
      )}
      {...props} />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
