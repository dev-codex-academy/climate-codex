    ...
    return (
        <div className="p-4 md:p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {entities.map(entity => (
                    <div key={entity} className="bg-card text-card-foreground rounded-xl border border-border shadow-sm flex flex-col h-full bg-codex-cards-cuaternario dark:bg-codex-cards-secondary">
